-- ============================================================
-- V2 — Datos de referencia del juego
--
-- Tablero fijo del TEG: continentes, países, fronteras, objetivos
-- y mazo de tarjetas. Migrado desde el viejo data.sql (que Spring
-- solo ejecutaba en H2 embebido y por eso nunca poblaba Postgres).
--
-- Los nombres de países se mantienen EXACTAMENTE como estaban: el
-- frontend los corrige para mostrarlos vía NombrePaisPipe
-- (Yukon→Yukón, Mexico→México, ...). Cambiar la ortografía acá
-- rompería ese mapeo.
-- ============================================================
...
INSERT INTO tarjetas (id_tarjeta, id_pais, simbolo) VALUES
    -- América del Norte
    (1, 1, 'CANION'),   (2, 2, 'GALEON'),  (3, 3, 'GLOBO'),
    (4, 4, 'GLOBO'),    (5, 5, 'GLOBO'),   (6, 6, 'CANION'),
    (7, 7, 'GLOBO'),    (8, 8, 'GLOBO'),   (9, 9, 'GALEON'),
    (10, 10, 'GLOBO'),
    -- América del Sur
    (11, 11, 'GALEON'), (12, 12, 'CANION'), (13, 13, 'CANION'),
    (14, 14, 'COMODIN'),(15, 15, 'GALEON'), (16, 16, 'GALEON'),
    -- Europa
    (17, 17, 'CANION'), (18, 18, 'CANION'), (19, 19, 'GALEON'),
    (20, 20, 'GALEON'), (21, 21, 'CANION'), (22, 22, 'GLOBO'),
    (23, 23, 'GALEON'), (24, 24, 'CANION'), (25, 25, 'GALEON'),
    -- África
    (26, 26, 'GLOBO'),  (27, 27, 'GALEON'), (28, 28, 'GALEON'),
    (29, 29, 'CANION'), (30, 30, 'GLOBO'),  (31, 31, 'CANION'),
    -- Asia
    (32, 32, 'GLOBO'),  (33, 33, 'GLOBO'),  (34, 34, 'GALEON'),
    (35, 35, 'GLOBO'),  (36, 36, 'CANION'), (37, 37, 'CANION'),
    (38, 38, 'GALEON'), (39, 39, 'CANION'), (40, 40, 'CANION'),
    (41, 41, 'CANION'), (42, 42, 'GLOBO'),  (43, 43, 'GALEON'),
    (44, 44, 'GLOBO'),  (45, 45, 'GLOBO'),  (46, 46, 'GALEON'),
    -- Oceanía
    (47, 47, 'GALEON'), (48, 48, 'CANION'), (49, 49, 'GLOBO'),
    (50, 50, 'GLOBO');

-- Las filas de arriba traen IDs explícitos, así que las secuencias de identidad
-- siguen en 1 y el primer INSERT que delegue el ID chocaría con una PK existente.
-- setval las adelanta al máximo ya usado.
SELECT setval(pg_get_serial_sequence('continentes', 'id_continente'), (SELECT MAX(id_continente) FROM continentes));
SELECT setval(pg_get_serial_sequence('paises',      'id_pais'),       (SELECT MAX(id_pais)       FROM paises));
SELECT setval(pg_get_serial_sequence('tarjetas',    'id_tarjeta'),    (SELECT MAX(id_tarjeta)    FROM tarjetas));
